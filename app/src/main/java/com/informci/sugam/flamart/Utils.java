package com.informci.sugam.flamart;
...
/**
 * Created by Sugam Malviya on 28/11/16.
 * www.informci.com
 */
public class Utils {
    ...
    public static void bookmarkUrl(Context context, String url) {
        SharedPreferences pref = context.getSharedPreferences("informci", 0); // 0 - for private mode
    ...
    public static boolean isBookmarked(Context context, String url) {
        SharedPreferences pref = context.getSharedPreferences("informci", 0);
